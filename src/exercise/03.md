...
When unmounting the Child, e.g. hide it in the DOM, React (1) renders the parent
form start to end, (2) runs the child useEffect cleanups, (3) runs the parent
useEffect clean up, and (4) the parent useEffect updates.
